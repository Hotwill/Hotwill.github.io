...
搭建VPN服务器，实际上是安装pptp服务器。实际上就两步，一是配置pptp，而是增加路由转发。过程可以参考[**这篇博客**](http://yansu.org/2013/12/11/deploy-pptp-vpn-in-ubuntu.html)，我就不赘述了。

## 一键安装脚本

在网上找到一个一键安装的shell脚本，出自[**这里**](https://github.com/viljoviitanen/setup-simple-pptp-vpn)。下面我将它的代码贴出来。
