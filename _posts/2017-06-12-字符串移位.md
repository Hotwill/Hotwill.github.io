...
YX = (X^TY^T)^T
$$
<a href="https://www.codecogs.com/eqnedit.php?latex=YX&space;=&space;(X^TY^T)^T" target="_blank"><img src="https://latex.codecogs.com/gif.latex?YX&space;=&space;(X^TY^T)^T" title="YX = (X^TY^T)^T" /></a>
